                        ...
                        <#list specificationList as item>
                            ...
                            <dl>
                                ...
                                <#list item.attributeValue as attr>
                                    <dd><a href="javascript:;"class="{{isSelected('${item.attributeName}','${attr}')?'selected':''}}"
                                           ng-click="selectSpecification('${item.attributeName}','${attr}');">${attr}<span title="点击取消选择">&nbsp;</span></a></dd>
                                </#list>
                            </dl>
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a  ng-click="addCartToCartList()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
